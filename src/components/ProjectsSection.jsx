...
//       location: 'Mumbai',
//       description:
//         'A digital system that streamlines visitor check-ins, enhances security, and maintains records efficiently.',
// achievements: [
//   '50+ visitors daily',
//   '30% faster check-ins',
...
// ],
//       tech: ['.Node', 'React.js', 'AWS'],
//       icon: Rocket,
//       color: ACCENT_ORANGE,
//       projectUrl: 'https://vms.mahaagromart.com/login',
//       githubUrl: null,
//     },
//   ];
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        {/* ── Cards Grid ── */}
        {/* FIX: items-stretch ensures all cards in a row share the same height */}
          ...
          {projects.map((item, index) => {
            ...
            return (
              <div
                ...
                onMouseLeave={() => setActiveIndex(null)}
              >
                {/* FIX: h-full so the card stretches to fill the grid row height */}
                <div
                ...
                >
                  ...
                  {/* FIX: flex flex-col h-full so buttons can be pushed to the bottom */}
                  <div className="p-8 flex flex-col h-full">
                    ...
                    {/* ── Buttons ── */}
                    {/* FIX: mt-auto pushes buttons to the bottom of every card */}
                    <div className="flex gap-3 mt-auto pt-6 relative z-20">
                      <a
                        href={item.projectUrl || '#'}
                        target="_blank"
                        rel="noopener noreferrer"
